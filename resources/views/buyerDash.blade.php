...
<div class="container profile">
   ...
   <form class="" role="search" method="POST" action="{{ route('profile.updateBuyer) }}">
      ...
      <div class="row mb-3">
            ...
            <div class="col-md-4">
               <input id="address" type="text" class="form-control" name="address" value="{{ $data->address }}" required autocomplete="address">
            </div>                        
      </div>
